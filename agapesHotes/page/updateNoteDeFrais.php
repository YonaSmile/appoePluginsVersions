...
if (!empty($_GET['secteur']) && !empty($_GET['site'])):
    ...
    if (
        ...
        echo getTitle($Page->getName(), $Page->getSlug(), ' de <strong id="siteName">' . $Site->getNom() . '</strong>');
        ?>
        <div class="row">
            <div class="col-12">
        ...
        <div id="NoteDeFraisContainer" class="row"></div>
        <script>
            $(document).ready(function () {
                ...
                $('#NoteDeFraisContainer').load('<?= AGAPESHOTES_URL . 'page/getNoteDeFraisData.php'; ?>', {
