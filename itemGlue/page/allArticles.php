...
<?php if ($allArticles): ?>
    <div id="admin-tabs-menu" class="row">
        ...
        <div class="d-none d-lg-block col-lg-3">Statut</div>
        ...
        <?php foreach ($allArticles as $article):
            ...
            <div class="admin-tab" data-idarticle="<?= $article->id ?>"
                ...
                <div class="admin-tab-header">
                    <div class="col-sm-12 col-lg-3"><?= shortenText($article->name, 50); ?></div>
                    <div class="d-none d-lg-block col-lg-3"><?= shortenText($article->slug, 50); ?></div>
                    <div class="d-none d-lg-block col-lg-3" data-article="status"><?= ITEMGLUE_STATUS[$article->statut]; ?></div>
