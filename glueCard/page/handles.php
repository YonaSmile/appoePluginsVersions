                    ...
                    <div class="card-body">
                        ...
                        <form method="post" data-handle-id="<?= $handle->id; ?>" class="newPlanForm container my-5">
                            ...
                            <small class="text-muted d-block mb-1">Ajoutez un plan à la structure de vos cartes en
                                choisissant le type de donnée qui y sera stockée</small>
                            <div class="form-row">
                                ...
                                <div class="col-12 col-md-3 mb-2">
                                    <select class="custom-select selectPlan" name="newPlanInputType" required>
                                        ...
                                        <option value="text" data-description="Un champs texte simple">Texte</option>
                                        <option value="tel" data-description="Un champs de numéros">Téléphone</option>
                                        <option value="email" data-description="Un champs email">Email</option>
                                        <option value="url" data-description="Un champs de lien hypertext">Lien</option>
                                        <option value="urlFile"
                                                data-description="Un champs de lien hypertext avec choix dans la bibliothèque">
                                            Lien media
                                        </option>
                                    ...
                                    <small class="text-muted d-block">Déterminez le type de donnée</small>
                                </div>
