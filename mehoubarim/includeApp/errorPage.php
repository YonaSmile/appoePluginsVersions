...
if (in_array('app', $mehoubarim_url_parts) && in_array('page', $mehoubarim_url_parts)) {
    ...
    if (true !== $mehoubarim && false !== $mehoubarim) {
        ...
        $mehoubarim_html = str_replace('{message}', trans('Cette page est en ce moment manipulé par') . ' <strong>' . getUserEntitled(\App\ShinouiKatan::Decrypter($mehoubarim)) . '</strong>', $mehoubarim_html);
